...
import { cta } from "../../public/assets/landing-assets";

const CTA = () => {
  return (
    <div className="w-full bg-[#f0f0f0] py-24 rounded-3xl">
      <div className="md:max-w-[1480px] m-auto grid md:grid-cols-2 gap-8 max-w-[600px] items-center  px-4 md:px-0">
        ...
        <div>
          ...
          <button className="max-[780px]:w-full my-4 px-8 py-5  bg-brand text-white font-bold rounded-full">
            Sign Up For Free
          </button>
        </div>
      </div>
