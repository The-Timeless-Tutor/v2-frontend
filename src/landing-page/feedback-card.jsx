    ...
    <div className="bg-white p-8 rounded-3xl shadow-xl my-8 mx-2">
      ...
      <div className="py-8">
        <h3 className="text-lg">
          ...
          turpis. In hac habitasse platea dictumst. Praesent nulla massa, hendrerit vestibulum
          gravida in, feugiat auctor felis.Ut pharetra ipsum nec leo blandit, sit amet tincidunt
          eros pharetra. Nam sed imperdiet turpis. In hac habitasse platea dictumst.
        </h3>
      </div>
    </div>
  );
